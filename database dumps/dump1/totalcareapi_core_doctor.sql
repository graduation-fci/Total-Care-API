...
CREATE TABLE `core_doctor` (
  ...
  CONSTRAINT `core_doctor_person_ptr_id_eb9d7b08_fk_core_person_id` FOREIGN KEY (`person_ptr_id`) REFERENCES `core_person` (`id`)
...
-- Dump completed on 2023-04-16  6:19:46
